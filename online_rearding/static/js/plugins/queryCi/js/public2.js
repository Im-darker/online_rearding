...
function sendCitiesAjax() {
    $.ajax({
        type: "get",
        url: '/static/js/plugins/queryCi/js/queryAllCities.js',
        async: false,
        dataType: "json",
...
function sendAllProvinceAjax() {
    $.ajax({
        type: "get",
        url: '/static/js/plugins/queryCi/js/queryAllProvinces.js',
        async: false,
        dataType: "json",
        success: function(data) {
...
function sendAllCitiesAjax() {
    $.ajax({
        type: "get",
        url: '/static/js/plugins/queryCi/js/queryCities.js',
        async: false,
        dataType: "json",
        success: function(data) {
...
function sendAllCountiesAjax(){
    $.ajax({
        type: "get",
        url: "/static/js/plugins/queryCi/js/queryAllAreas.js",
        async: false,
        dataType: "json",
        success: function(data) {
            allAreas = data.areas;
