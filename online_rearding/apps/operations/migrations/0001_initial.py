    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fav_type', models.IntegerField(choices=[(1, '课程'), (2, '讲师'), (3, '课程机构')], default=1, verbose_name='收藏类型')),
            ],
            options={
                'verbose_name': '用户收藏',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_start', models.BooleanField(choices=[(0, '未读'), (1, '已读')], verbose_name='是否已读')),
            ],
            options={
                'verbose_name': '用户消息',
